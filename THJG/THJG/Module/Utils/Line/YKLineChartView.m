...
-(void)setupFrame{
    ...
    _underSpaceLegnth = self.bounds.size.height/7;
...
-(void)touchAtIndex:(NSInteger)index{
    ...
    NSString *showContent = [NSString stringWithFormat:@"%.0f",[[_dataSource.showNumbers objectAtIndex:index-1] doubleValue]];
